        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="px-4 py-2 rounded-full bg-forest-900 hover:bg-terracotta-600 hover:text-white transition-colors">
                Instagram
              </a>
              <a href="#" className="px-4 py-2 rounded-full bg-forest-900 hover:bg-terracotta-600 hover:text-white transition-colors">
                Twitter
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/resorts" className="hover:text-terracotta-500 transition-colors">Our Resorts</Link></li>
              <li><Link href="/experiences" className="hover:text-terracotta-500 transition-colors">Experiences</Link></li>
              <li><Link href="/about" className="hover:text-terracotta-500 transition-colors">Our Story</Link></li>
              <li><Link href="/gallery" className="hover:text-terracotta-500 transition-colors">Gallery</Link></li>
            </ul>
          </div>
