...
export function Resorts() {
  ...
  const { resorts, total, isEmpty, maxPrice } = useResorts({
  ...
  return (
    <>
      <div className="min-h-screen bg-sand-50 pt-20">
        {/* Search Header */}
        <div className="bg-forest-950 py-8 px-4">
          ...
          {location && (
            <div className="flex items-center gap-2 mb-6 text-stone-600">
              ...
              <span className="text-sm">
                Results for <strong className="text-forest-950">"{location}"</strong>
              </span>
            </div>
          )}
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 mb-4 lg:hidden">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-xl border border-stone-200 bg-white text-stone-700 font-semibold text-sm hover:border-stone-400 transition-colors"
                >
                  <SlidersHorizontal className="w-4 h-4" />
                  Filters
                  {(filters.amenities.length + filters.types.length + (filters.minRating > 0 ? 1 : 0)) > 0 && (
                    <span className="bg-terracotta-600 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
              ...
              {/* Map View */}
              {view === "map" && (
                <div className="mt-6 rounded-3xl overflow-hidden border border-stone-200" style={{ height: "600px" }}>
                  ...
                  {isEmpty ? (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 text-terracotta-600 font-bold hover:underline"
                      >
