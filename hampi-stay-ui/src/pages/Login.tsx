  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-sand-50 relative overflow-hidden">
      ...
      <div className="relative w-full md:w-1/2 h-full min-h-screen flex items-center justify-center p-6 md:p-12 lg:p-24 z-10 -mt-10 md:mt-0">
        ...
        >
          {/* Back button */}
          <Link to="/" className="absolute top-8 left-8 text-stone-400 hover:text-stone-800 transition-colors">
          ...
          <motion.form variants={itemVariant} className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between py-2">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input type="checkbox" className="w-4 h-4 rounded border-stone-300 text-terracotta-600 focus:ring-terracotta-500 transition-colors" />
            ...
            <Button type="submit" className="w-full h-14 text-lg mt-4 bg-forest-800 hover:bg-forest-950 shadow-luxury">
              Sign In
            </Button>
          </motion.form>
          ...
          <motion.div variants={itemVariant} className="text-center mt-10">
            <p className="text-stone-500 font-medium">
              ...
              <Link to="/register" className="text-forest-700 font-bold hover:text-terracotta-600 transition-colors">
                Sign up
              </Link>
            </p>
          </motion.div>
